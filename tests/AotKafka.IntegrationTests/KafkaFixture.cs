...
public class KafkaFixture : IAsyncLifetime
{
    ...
    public const ushort BrokerPortSasl = 9095;
...
KafkaClient {
  ...
  .WithPortBinding(hostSasl, BrokerPortSasl)   // hostSasl      : 9095

  // listeners: two external + two internal
  .WithEnvironment("KAFKA_LISTENERS",
    $"PLAINTEXT://:{KafkaPort},SASL_PLAINTEXT://:{BrokerPortSasl},BROKER://:{BrokerPort},CONTROLLER://:{ControllerPort}")
  ...
  .WithEnvironment("KAFKA_ADVERTISED_LISTENERS",
    ...
    $"SASL_PLAINTEXT://127.0.0.1:{hostSasl}," +
  ...
  .Build();
        ...
        _saslBootstrapServers = $"127.0.0.1:{hostSasl}";
    }
